    ...
    public void sendPasswordResetEmail(String toEmail, String resetLink) {
         ...
         try {
             ...
             String htmlContent = "<div style='font-family: Arial, sans-serif; text-align: center; padding: 30px;'>"
             		...
             		+ "<p style='font-size: 14px; '>A request has been made to reset the password for <strong>" + toEmail + "</strong>.</p>"
                    + "<p style='font-size: 14px; '>Please click the button below to reset your password:</p>"
